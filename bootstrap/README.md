...
This folder contains the bootstrapping process and initial fixup notes for busybee.
...
Session dumps are stored in `../sessions/`, indexed chronologically:
- `001-bootstrap-session.json` - Initial bootstrap session
- `002-dev-loop-session.json` - Dev loop build session
- `003-fixup-script-session.json` - Fixup script session
- `004-fixup-github-ssh-session.json` - Fixup GitHub SSH session
- `005-fixup-opencode-run-session.json` - Fixup opencode run session
- `006-fixup-branch-exists-session.json` - Fixup branch exists session
- `007-fixup-nothing-to-commit-session.json` - Fixup nothing to commit session
- `008-fixup-syntax.json` - Fixup syntax session
- `009-issue-picking-bug.json` - Issue picking bug session
